...
/*
 * JSP: This file was modified to include gapFunction and gapArguments parameters.
 *
 */
...
//	{0, 0, 0, 0, "=========== Alignment Function Options ==============================================", 5},
//	{"gapFunction", 'l', "gapFunction", 0, "Choose the function for homopolymer runs for the alignment.", 5},
//	{"gapArguments", 'r', "gapArguments", 0, "Specify the arguments for the homopolymer run function.", 5},
	{0, 0, 0, 0, 0, 0}
};
...
//		fprintf(fp, "gapFunction:\t\t\t\t\t%s\n", args->gapFunction);
//		fprintf(fp, "gapArguments:\t\t\t\t\t%s\n", args->gapArguments);
		fprintf(fp, BREAK_LINE);
	}
	return;
}
...
void BfastAlignFreeProgramParameters(struct arguments *args)
{
	...
	free(args->tmpDir);
	args->tmpDir=NULL;
//	free(args->gapArguments);
//	args->gapArguments=NULL;
}
...
//			case 'l':
//				arguments->gapFunction = atoi(optarg);
//				break;
//			case 'r':
//				arguments->gapArguments = strdup(optarg);
//				break;
			default:
				OptErr=1;
		} /* while */
