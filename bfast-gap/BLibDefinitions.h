...
/* Program defaults */
#define PROGRAM_NAME "bfast-gap" /* Could just use PACKAGE_NAME */
...
#define BFAST_TMP_TEMPLATE ".bfast-gap.tmp.XXXXXX"
...
#define SCORING_MATRIX_GAP_OPEN -400
#define SCORING_MATRIX_GAP_EXTEND -30
#define SCORING_MATRIX_NT_MATCH 96
#define SCORING_MATRIX_NT_MISMATCH -90
#define SCORING_MATRIX_COLOR_MATCH 0
#define SCORING_MATRIX_COLOR_MISMATCH -125
/* JSP: run scoring function default */
#define SCORING_FUNCTION 3
#define G1 1.0
#define G2 5.0
#define G3 0.0
#define G4 0.0
#define EXT_FUNCTION 3
#define E1 1.0
#define E2 5.0
#define E3 0.0
#define E4 0.0
#define TABLE_SIZE 100 // A constant for determining the size of the gap score lookup table.
...
typedef struct {
	...
	int32_t keysize;
	int32_t *mask;
	/* JSP: Count of insertions and deletions in the mask */
...
typedef struct {
	...
	// JSP: added function type for context sensitive stuff.
	int32_t gapFunction;
	double g1;
	double g2;
	double g3;
	...
	double e3;
	double e4;
	//JSP: lookup tables for the gap open and extension functions.
	double gapTable[TABLE_SIZE];
	double extTable[TABLE_SIZE];
} ScoringMatrix;

///* JSP A struct for the gap run function. */
//typedef struct {
